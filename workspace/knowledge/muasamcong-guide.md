...
### Tại sao dùng API thay browser?

MSC cung cấp API JSON trực tiếp — không cần browser headless. Gọi bằng `exec curl` nhanh, ổn định, không phụ thuộc Chromium/Playwright.
